...
export const addText = (textKey, state, user, n?) => {
  ...
  const { user1, user2, desiredRetirementIncome } = state.user_reducer
  ...
  const data = {
    ...
    combinedIncomeChart: {
      explanation: "This forms the basis of our financial calculations.",
      subTitle: "Our goal is to see what your government benefits in retirement looks like. If you're earning too much you can have these 'clawed back' through high taxes. By estimating your pension now we build a savings plan that saves you the most in taxes when you retire.",
    ...
    idealIncomeChart: {
      question: n === 1 ? "This shows your ideal income breakdown for when you retire." : 
      "This is what we've calulcated",
      subTitle: n === 1 ? "In a perfect world you would earn taxable income in the lowest tax bracket, around 40k. Then anything above that would come from your Tax Free Savings. With this plan you would keep all your government benefits and still be able to take advantage of tax savings by contributing to your RRSP now. " :
    ...
    incomeAmount: {
      ...
      subTitle: isUser1 && n === 0 ? `Give us an estimate of your ${stream.name} income. The "until" option is essentially when you'd like to retire. You can see how your Canada Pension Plan is calculated based on your earnings.` : `Give us an estimate of your ${stream.name} income`,
    },
    incomeName: {
