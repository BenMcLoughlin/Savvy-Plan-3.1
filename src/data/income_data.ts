...
export const createIncomeArray = (instance: IIncomeStream, setValue_action: any, state: any) => {
  ...
  const array: any = [
    //INTRO USER QUESTIONS
    {
      ...
      title: "What do you call this income incomeStream?",
    ...
    },
    {
      ...
      reducer: "main_reducer",
      title: past
        ? "How much were your average annual earnings when you started?"
        : "What do you think your average annual earnings will be?",
    },
    {
      ask:
