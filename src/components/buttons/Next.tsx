...
export const Next: FC<IProps> = ({ props, state, setValue_action, setDirection, value }) => {
  ...
  const valid =
    type === "year" ? subject.toString().length === 4 && +subject > 1930 && +subject < 2095 : type !== "year" ? subject.toString().length > 0 : false //checking to see if the input they entered is valid so they can move on
