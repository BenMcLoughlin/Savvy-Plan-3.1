...
import { adjustByCraIndex } from "model/calculations/income/data/CRAIndexRates_data"
import * as I from "model/calculations/income/types"

export const getAdjustedFamilyNetIncome = (income: I.incomeObject, year:I.year) => income[year].user2 ? income[year].user1.beforeTaxIncome + income[year].user2.beforeTaxIncome : income[year].user1.beforeTaxIncome

export const getBenefitBeforeReduction = (kidsBirthYearArray: I.kidsBirthYearArray, year: I.year) => {
...
export const getReduction = (adjustedFamilyNetIncome, kidsBirthYearArray: I.kidsBirthYearArray, year:I.year) => {
...
export const getCcb = (income: I.incomeObject, kidsBirthYearArray: I.kidsBirthYearArray, year:I.year) => { 
