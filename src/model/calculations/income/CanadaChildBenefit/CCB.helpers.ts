...
console.log('Object.keys(user_reducer).filter(d => d.startsWith("child")):', Object.keys(user_reducer).filter(d => d.startsWith("child")))
  ...
  console.log('kidsIdArray:', kidsIdArray)
