...
var cachecCalculateIncome = (function() {
  var cache = {};
  ...
  function f(state: I.state) {
    ...
    if (cacheKey in cache) {
      ...
      console.log("cachecCalculateIncome duration:", function_duration)
...
export const calculateIncome = (state: I.state) => cachecCalculateIncome(state)
